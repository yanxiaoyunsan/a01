        ...
        <div class="ecjia-container">
            <div class="ecjia-content">
                ...
                <div class="ecjia-fl wt-135">
                    <div class="ecjia-desc">
                        <span class="ecjia-text-name fsize-36">青岛华正</span>
						<span class="arrow-left edition-icon"></span>
                        <span class="ecjia-edition"></span>
                        ...
                        <div class="two-btn wt-30">
                            {if $mobile_iphone_download}<a class="ecjia-btn icon-btn" href="#" target="_blank"><i class="iphone icon"></i><span>iPhone端下载</span></a>{/if}
                            {if $mobile_android_download}<a class="ecjia-btn icon-btn" href="#" target="_blank"><i class="android icon"></i><span>Android端下载</span></a>{/if}
                        </div>
            ...
            <div class="ecjia-content">
                <div class="ecjia-title wt-80">
                    <h1 class="fsize-36">简介</h1>
                    <p class="wt-30">青岛华正信息技术有限公司是一家以软件开发、电子商务、系统集成，软件外包为主的高新技术企业，主要致力于为各企事业机关单位提供专业的信息化整体解决方案，以及电子政务、协同商务、信息平台、网络安全等全方位的管理咨询和技术服务。</p>
                </div>
                <div class="clyimges">
                    {if $screenshots}
                    ...
                    <div class="wt-50 download">
                        <div class="two-btn wt-30">
                            {if $mobile_iphone_download}<a class="ecjia-btn icon-btn blue" href="#" target="_blank"><i class="iphone icon"></i>iPhone端下载</a>{/if}
                            {if $mobile_android_download}<a class="ecjia-btn icon-btn green" href="#" target="_blank"><i class="android icon"></i>Android端下载</a>{/if}
                        </div>
                    </div>
                </div>
            </div>
