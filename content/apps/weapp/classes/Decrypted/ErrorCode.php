...
class ErrorCode
{
	const IllegalAesKey     = 'illegal_aes_key';
	const IllegalIv         = 'illegal_iv';
	const IllegalAes        = 'illegal_aes';
	const IllegalBuffer     = 'illegal_buffer';
	const DecodeBase64Error = 'decode_base64_error';
